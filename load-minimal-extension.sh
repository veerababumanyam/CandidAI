...
# Script to open Chrome with the minimal test extension loaded
# This script assumes Chrome is installed in the default location

# Set the path to the extension
EXTENSION_PATH="/Users/v13478/Desktop/CandidAI/minimal-test"
...
echo "Opening Chrome with minimal test extension..."
open -a "Google Chrome" --args --load-extension="$EXTENSION_PATH" --no-first-run

echo "Chrome should now be open with the minimal test extension loaded."
